...
BOOST_FIXTURE_TEST_CASE( buysell, sysio_system_tester ) try {

   BOOST_REQUIRE_EQUAL( core_sym::from_string("0.0000"), get_balance( "alice1111111" ) );

   transfer( "sysio", "alice1111111", core_sym::from_string("1000.0000"), "sysio" );
   BOOST_REQUIRE_EQUAL( success(), stake( "sysio", "alice1111111", core_sym::from_string("200.0000"), core_sym::from_string("100.0000") ) );

   auto total = get_total_stake( "alice1111111" );
   auto init_bytes =  total["ram_bytes"].as_uint64();

   const asset initial_ram_balance = get_balance("sysio.ram"_n);
   const asset initial_ramfee_balance = get_balance("sysio.ramfee"_n);
   ...
   BOOST_REQUIRE_EQUAL( initial_ram_balance + core_sym::from_string("199.0000"), get_balance("sysio.ram"_n) );
   BOOST_REQUIRE_EQUAL( initial_ramfee_balance + core_sym::from_string("1.0000"), get_balance("sysio.ramfee"_n) );
   ...
   transfer( "sysio", "alice1111111", core_sym::from_string("100000000.0000"), "sysio" );
...
BOOST_FIXTURE_TEST_CASE( stake_unstake, sysio_system_tester ) try {
   ...
   const auto init_sysio_stake_balance = get_balance( "sysio.stake"_n );
...
BOOST_FIXTURE_TEST_CASE( stake_unstake_with_transfer, sysio_system_tester ) try {
   cross_15_percent_threshold();

   BOOST_REQUIRE_EQUAL( core_sym::from_string("0.0000"), get_balance( "alice1111111" ) );

   //sysio stakes for alice with transfer flag

   transfer( "sysio", "bob111111111", core_sym::from_string("1000.0000"), "sysio" );
   ...
   transfer( "sysio", "alice1111111", core_sym::from_string("1000.0000"), "sysio" );
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "alice1111111", core_sym::from_string("200.0000"), core_sym::from_string("100.0000") ) );
   //now alice's stake should be equal to transferred from sysio + own stake
   total = get_total_stake("alice1111111");
   BOOST_REQUIRE_EQUAL( core_sym::from_string("700.0000"), get_balance( "alice1111111" ) );
...
BOOST_FIXTURE_TEST_CASE( stake_to_self_with_transfer, sysio_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( stake_while_pending_refund, sysio_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( fail_without_auth, sysio_system_tester ) try {
   cross_15_percent_threshold();

   issue_and_transfer( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );

   BOOST_REQUIRE_EQUAL( success(), stake( "sysio", "alice1111111", core_sym::from_string("2000.0000"), core_sym::from_string("1000.0000") ) );
...
BOOST_FIXTURE_TEST_CASE( stake_negative, sysio_system_tester ) try {
   issue_and_transfer( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( unstake_negative, sysio_system_tester ) try {
   issue_and_transfer( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( unstake_more_than_at_stake, sysio_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( delegate_to_another_user, sysio_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( stake_unstake_separate, sysio_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( adding_stake_partial_unstake, sysio_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( stake_from_refund, sysio_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( stake_to_another_user_not_from_refund, sysio_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( producer_wtmsig_transition, sysio_system_tester ) try {
   cross_15_percent_threshold();
   ...
   auto convert_to_block_timestamp = [](const fc::variant& timestamp) -> sysio::chain::block_timestamp_type {
...
BOOST_FIXTURE_TEST_CASE( vote_for_producer, sysio_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( unregistered_producer_voting, sysio_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   issue_and_transfer( "bob111111111", core_sym::from_string("2000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( more_than_30_producer_voting, sysio_system_tester ) try {
   issue_and_transfer( "bob111111111", core_sym::from_string("2000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111", core_sym::from_string("13.0000"), core_sym::from_string("0.5791") ) );
   REQUIRE_MATCHING_OBJECT( voter( "bob111111111", core_sym::from_string("13.5791") ), get_voter_info( "bob111111111" ) );
...
BOOST_FIXTURE_TEST_CASE( vote_same_producer_30_times, sysio_system_tester ) try {
   issue_and_transfer( "bob111111111", core_sym::from_string("2000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( producer_keep_votes, sysio_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   issue_and_transfer( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );
   fc::variant params = producer_parameters_example(1);
...
BOOST_FIXTURE_TEST_CASE( vote_for_two_producers, sysio_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   //alice1111111 becomes a producer
   fc::variant params = producer_parameters_example(1);
...
BOOST_FIXTURE_TEST_CASE( proxy_register_unregister_keeps_stake, sysio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( proxy_stake_unstake_keeps_proxy_flag, sysio_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( proxy_actions_affect_producers, sysio_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE(producer_pay, sysio_system_tester, * boost::unit_test::tolerance(1e-10)) try {
   ...
   // produce enough blocks so new schedule kicks in and defproducera produces some blocks
   {
      ...
      const int64_t  initial_savings           = get_balance("sysio.saving"_n).get_amount();
      ...
      const int64_t  savings           = get_balance("sysio.saving"_n).get_amount();
...
BOOST_FIXTURE_TEST_CASE(change_inflation, sysio_system_tester) try {
...

   {
      ...
      auto run_for_1year = [this](int64_t annual_rate, int64_t inflation_pay_factor, int64_t votepay_factor) {
         ...
         const int64_t final_savings = get_balance("sysio.saving"_n).get_amount();
...
BOOST_AUTO_TEST_CASE(extreme_inflation) try {
   sysio_system_tester t(sysio_system_tester::setup_level::minimal);
   symbol core_symbol{CORE_SYM};
   t.create_currency( "sysio.token"_n, config::system_account_name, asset((1ll << 62) - 1, core_symbol) );
   ...
   {
      vector<char> data = t.get_row_by_account( "sysio.token"_n, name(core_symbol.to_symbol_code().value), "stat"_n, account_name(core_symbol.to_symbol_code().value) );
      current_supply = t.token_abi_ser.binary_to_variant("currency_stats", data, abi_serializer::create_yield_function(sysio_system_tester::abi_serializer_max_time))["supply"].template as<asset>();
   }
...
BOOST_FIXTURE_TEST_CASE(multiple_producer_pay, sysio_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...

   {
      ...
      const uint32_t initial_tot_unpaid_blocks = initial_global_state["total_unpaid_blocks"].as<uint32_t>();
      const asset    initial_supply            = get_token_supply();
      const asset    initial_bpay_balance      = get_balance("sysio.bpay"_n);
      const asset    initial_vpay_balance      = get_balance("sysio.vpay"_n);
      ...
      const uint32_t tot_unpaid_blocks = global_state["total_unpaid_blocks"].as<uint32_t>();
      const asset    supply            = get_token_supply();
      const asset    bpay_balance      = get_balance("sysio.bpay"_n);
      const asset    vpay_balance      = get_balance("sysio.vpay"_n);
...
BOOST_FIXTURE_TEST_CASE(multiple_producer_votepay_share, sysio_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...
BOOST_FIXTURE_TEST_CASE(votepay_share_invariant, sysio_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...
BOOST_FIXTURE_TEST_CASE(votepay_share_proxy, sysio_system_tester, * boost::unit_test::tolerance(1e-5)) try {
...
BOOST_FIXTURE_TEST_CASE(votepay_share_update_order, sysio_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...
BOOST_FIXTURE_TEST_CASE(votepay_transition, sysio_system_tester, * boost::unit_test::tolerance(1e-10)) try {
   ...
   auto* tbl = control->db().find<sysio::chain::table_id_object, sysio::chain::by_code_scope_table>(
   ...
   tbl = control->db().find<sysio::chain::table_id_object, sysio::chain::by_code_scope_table>(
                  boost::make_tuple( config::system_account_name,
                                     config::system_account_name,
                                     "producers2"_n ) );
   BOOST_REQUIRE( !tbl );
...
BOOST_AUTO_TEST_CASE(votepay_transition2, * boost::unit_test::tolerance(1e-10)) try {
   ...
   symbol old_contract_core_symbol{::sysio::chain::string_to_symbol_c( 4, old_contract_core_symbol_name.c_str() )};

   auto old_core_from_string = [&]( const std::string& s ) {
      return sysio::chain::asset::from_string(s + " " + old_contract_core_symbol_name);
   };
   ...
   t.set_abi(  config::system_account_name, contracts::util::system_abi_old().data() );
   {
      ...
      t.abi_ser.set_abi(abi, abi_serializer::create_yield_function(sysio_system_tester::abi_serializer_max_time));
   }
   ...
   auto* tbl = t.control->db().find<sysio::chain::table_id_object, sysio::chain::by_code_scope_table>(
                                    boost::make_tuple( config::system_account_name,
                                                       config::system_account_name,
                                                       "producers2"_n ) );
   BOOST_REQUIRE( !tbl );
...
BOOST_FIXTURE_TEST_CASE(producer_onblock_check, sysio_system_tester) try {
...
BOOST_FIXTURE_TEST_CASE( voters_actions_affect_proxy_and_producers, sysio_system_tester, * boost::unit_test::tolerance(1e+6) ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( vote_both_proxy_and_producers, sysio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( select_invalid_proxy, sysio_system_tester ) try {
   //accumulate proxied votes
   issue_and_transfer( "bob111111111", core_sym::from_string("1000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111", core_sym::from_string("100.0002"), core_sym::from_string("50.0001") ) );
...
BOOST_FIXTURE_TEST_CASE( double_register_unregister_proxy_keeps_votes, sysio_system_tester ) try {
   //alice1111111 becomes a proxy
   BOOST_REQUIRE_EQUAL( success(), push_action( "alice1111111"_n, "regproxy"_n, mvo()
                                                ("proxy",  "alice1111111")
                                                ("isproxy",  1)
...
BOOST_FIXTURE_TEST_CASE( proxy_cannot_use_another_proxy, sysio_system_tester ) try {
   //alice1111111 becomes a proxy
   BOOST_REQUIRE_EQUAL( success(), push_action( "alice1111111"_n, "regproxy"_n, mvo()
                                                ("proxy",  "alice1111111")
                                                ("isproxy",  1)
...
BOOST_FIXTURE_TEST_CASE( elect_producers /*_and_parameters*/, sysio_system_tester ) try {
   create_accounts_with_resources( {  "defproducer1"_n, "defproducer2"_n, "defproducer3"_n } );
   BOOST_REQUIRE_EQUAL( success(), regproducer( "defproducer1"_n, 1) );
   BOOST_REQUIRE_EQUAL( success(), regproducer( "defproducer2"_n, 2) );
   BOOST_REQUIRE_EQUAL( success(), regproducer( "defproducer3"_n, 3) );
...
BOOST_FIXTURE_TEST_CASE( buyname, sysio_system_tester ) try {
   ...
   BOOST_REQUIRE_EXCEPTION( create_accounts_with_resources( { "fail"_n }, "dan"_n ), // dan shouldn't be able to create fail
                            sysio_assert_message_exception, sysio_assert_message_is( "no active bid for name" ) );
   ...
   BOOST_REQUIRE_EXCEPTION( create_accounts_with_resources( { "nofail"_n }, "dan"_n ), // dan shoudn't be able to do this, sam won
                            sysio_assert_message_exception, sysio_assert_message_is( "only highest bidder can claim" ) );
   ...
   transfer( "sysio", "nofail", core_sym::from_string( "1000.0000" ) );
   ...
   BOOST_REQUIRE_EXCEPTION( create_accounts_with_resources( { "test.fail"_n }, "dan"_n ), // dan shouldn't be able to do this
                            sysio_assert_message_exception, sysio_assert_message_is( "only suffix may create this account" ) );

   create_accounts_with_resources( { "goodgoodgood"_n }, "dan"_n ); /// 12 char names should succeed
} FC_LOG_AND_RETHROW()

BOOST_FIXTURE_TEST_CASE( bid_invalid_names, sysio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( multiple_namebids, sysio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( namebid_pending_winner, sysio_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( vote_producers_in_and_out, sysio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( setram_effect, sysio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( ram_inflation, sysio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( sysioram_ramusage, sysio_system_tester ) try {
   BOOST_REQUIRE_EQUAL( core_sym::from_string("0.0000"), get_balance( "alice1111111" ) );
   transfer( "sysio", "alice1111111", core_sym::from_string("1000.0000"), "sysio" );
   BOOST_REQUIRE_EQUAL( success(), stake( "sysio", "alice1111111", core_sym::from_string("200.0000"), core_sym::from_string("100.0000") ) );
   ...
   BOOST_REQUIRE_EQUAL( false, get_row_by_account( "sysio.token"_n, "alice1111111"_n, "accounts"_n, account_name(symbol{CORE_SYM}.to_symbol_code()) ).empty() );

   //remove row
   base_tester::push_action( "sysio.token"_n, "close"_n, "alice1111111"_n, mvo()
                             ( "owner", "alice1111111" )
                             ( "symbol", symbol{CORE_SYM} )
   );
   BOOST_REQUIRE_EQUAL( true, get_row_by_account( "sysio.token"_n, "alice1111111"_n, "accounts"_n, account_name(symbol{CORE_SYM}.to_symbol_code()) ).empty() );

   auto rlm = control->get_resource_limits_manager();
   auto sysioram_ram_usage = rlm.get_account_ram_usage("sysio.ram"_n);
   auto alice_ram_usage = rlm.get_account_ram_usage("alice1111111"_n);

   BOOST_REQUIRE_EQUAL( success(), sellram( "alice1111111", 2048 ) );

   //make sure that ram was billed to alice, not to sysio.ram
   BOOST_REQUIRE_EQUAL( true, alice_ram_usage < rlm.get_account_ram_usage("alice1111111"_n) );
   BOOST_REQUIRE_EQUAL( sysioram_ram_usage, rlm.get_account_ram_usage("sysio.ram"_n) );

} FC_LOG_AND_RETHROW()

BOOST_FIXTURE_TEST_CASE( ram_gift, sysio_system_tester ) try {
   ...
   */
   ...
   BOOST_REQUIRE_EQUAL( success(), unstake( "sysio", "alice1111111", core_sym::from_string("20.0000"), core_sym::from_string("10.0000") ) );
...
BOOST_FIXTURE_TEST_CASE( rex_rounding_issue, sysio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( rex_auth, sysio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( buy_sell_rex, sysio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( buy_sell_small_rex, sysio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( unstake_buy_rex, sysio_system_tester, * boost::unit_test::tolerance(1e-10) ) try {
...

   {
      ...
      const asset init_sysio_stake_balance = get_balance( "sysio.stake"_n );
      ...
      BOOST_REQUIRE_EQUAL( tot_stake,                               get_balance( "sysio.rex"_n ) );
      BOOST_REQUIRE_EQUAL( tot_stake,                               init_sysio_stake_balance - get_balance( "sysio.stake"_n ) );
...
BOOST_FIXTURE_TEST_CASE( buy_rent_rex, sysio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( buy_sell_sell_rex, sysio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( buy_sell_claim_rex, sysio_system_tester ) try {
   ...
   const int64_t init_alice_rex_stake = ( sysio::chain::uint128_t(init_alice_rex.get_amount()) * total_lendable ) / total_rex;
...
BOOST_FIXTURE_TEST_CASE( rex_loans, sysio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( rex_loan_checks, sysio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( ramfee_namebid_to_rex, sysio_system_tester ) try {
   ...
   asset cur_ramfee_balance = get_balance( "sysio.ramfee"_n );
   BOOST_REQUIRE_EQUAL( success(),                      buyram( alice, alice, core_sym::from_string("20.0000") ) );
   BOOST_REQUIRE_EQUAL( get_balance( "sysio.ramfee"_n ), core_sym::from_string("0.1000") + cur_ramfee_balance );
   ...
   cur_ramfee_balance = get_balance( "sysio.ramfee"_n );
   asset cur_rex_balance = get_balance( "sysio.rex"_n );
   ...
   BOOST_REQUIRE_EQUAL( cur_ramfee_balance,                get_balance( "sysio.ramfee"_n ) );
   BOOST_REQUIRE_EQUAL( get_balance( "sysio.rex"_n ),       cur_rex_balance + core_sym::from_string("0.3500") );

   cur_rex_balance = get_balance( "sysio.rex"_n );
   ...
   BOOST_REQUIRE_EQUAL( get_balance( "sysio.rex"_n ),      cur_rex_balance + core_sym::from_string("34.3500") );
   BOOST_REQUIRE_EQUAL( 0,                                get_balance( "sysio.names"_n ).get_amount() );
...
BOOST_FIXTURE_TEST_CASE( rex_maturity, sysio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( rex_savings, sysio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( update_rex, sysio_system_tester, * boost::unit_test::tolerance(1e-10) ) try {
   ...
   const int64_t init_alice_rex_stake = ( sysio::chain::uint128_t(init_rex.get_amount()) * total_lendable ) / total_rex;
...
BOOST_FIXTURE_TEST_CASE( update_rex_vote, sysio_system_tester, * boost::unit_test::tolerance(1e-8) ) try {
...
BOOST_FIXTURE_TEST_CASE( deposit_rex_fund, sysio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( rex_lower_bound, sysio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( close_rex, sysio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( set_rex, sysio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( b1_vesting, sysio_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( error("missing authority of sysio"), vote( b1, { }, "proxyaccount"_n ) );
...
BOOST_FIXTURE_TEST_CASE( rex_return, sysio_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( change_limited_account_back_to_unlimited, sysio_system_tester ) try {
   BOOST_REQUIRE( get_total_stake( "sysio" ).is_null() );

   transfer( "sysio"_n, "alice1111111"_n, core_sym::from_string("1.0000") );

   auto error_msg = stake( "alice1111111"_n, "sysio"_n, core_sym::from_string("0.0000"), core_sym::from_string("1.0000") );
   auto semicolon_pos = error_msg.find(';');

   BOOST_REQUIRE_EQUAL( error("account sysio has insufficient ram"),
   ...
   push_action( "sysio"_n, "setalimits"_n, mvo()
                                          ("account", "sysio")
   ...
   stake( "alice1111111"_n, "sysio"_n, core_sym::from_string("0.0000"), core_sym::from_string("1.0000") );

   REQUIRE_MATCHING_OBJECT( get_total_stake( "sysio" ), mvo()
      ("owner", "sysio")
   ...
   BOOST_REQUIRE_EQUAL( success(),
                        push_action( "sysio"_n, "setacctnet"_n, mvo()
                           ("account", "sysio")
                           ("net_weight", -1)
                        )
   );
   ...
   BOOST_REQUIRE_EQUAL( success(),
                        push_action( "sysio"_n, "setacctcpu"_n, mvo()
                           ("account", "sysio")
                           ("cpu_weight", -1)
...
BOOST_FIXTURE_TEST_CASE( buy_pin_sell_ram, sysio_system_tester ) try {
   BOOST_REQUIRE( get_total_stake( "sysio" ).is_null() );

   transfer( "sysio"_n, "alice1111111"_n, core_sym::from_string("1020.0000") );

   auto error_msg = stake( "alice1111111"_n, "sysio"_n, core_sym::from_string("10.0000"), core_sym::from_string("10.0000") );
   auto semicolon_pos = error_msg.find(';');
   ...
   BOOST_REQUIRE_EQUAL( success(), buyrambytes( "alice1111111"_n, "sysio"_n, static_cast<uint32_t>(ram_bytes_needed) ) );

   auto tokens_paid_for_ram = alice_original_balance - get_balance( "alice1111111"_n );

   auto total_res = get_total_stake( "sysio" );
   ...
   BOOST_REQUIRE_EQUAL( success(),
                        push_action( "sysio"_n, "setacctram"_n, mvo()
                           ("account", "sysio")
                           ("ram_bytes", total_res["ram_bytes"].as_int64() )
                        )
   );

   auto sysio_original_balance = get_balance( "sysio"_n );

   BOOST_REQUIRE_EQUAL( success(), sellram( "sysio"_n, total_res["ram_bytes"].as_int64() ) );

   auto tokens_received_by_selling_ram = get_balance( "sysio"_n ) - sysio_original_balance;
