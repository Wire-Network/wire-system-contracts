...
namespace sysioboot {
   ...
   /**
    * @defgroup sysioboot sysio.boot
    * @ingroup sysiocontracts
    *
    * sysio.boot is a extremely minimalistic system contract that only supports the native actions and an
    * activate action that allows activating desired protocol features prior to deploying a system contract
    * with more features such as sysio.bios or sysio.system.
    *
    * @{
    */
   class [[sysio::contract("sysio.boot")]] boot : public sysio::contract {
      public:
   ...
   /** @}*/ // end of @defgroup sysioboot sysio.boot
} /// namespace sysioboot
